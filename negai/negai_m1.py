...
def generate_price_range(product_name, mentioned_price, affordable_price,history_data):
    historical_data = history_data or {"average_price": mentioned_price * 0.9, "trend": 1.0, "demand": 1.0}
